  ...
  <div>
    ...
    <center>
      <div v-if="carrito.length === 0" class="empty-cart">
        ...
        <br>
        <br>
        <img width="80" height="80" src="https://img.icons8.com/pastel-glyph/64/FFFFFF/shopping-cart--v2.png" alt="shopping-cart--v2"/>
        <h1 style="color:white">Tu carrito está vacío</h1>
      </div>
    </center>
    ...
    <div v-if="carrito.length > 0">
      ...
      <tr v-for="item in carrito" :key="item.id">
        ...
        <td>
          <input type="number" v-model="item.cantidad" min="1" :maxlength="item.cantidad" @change="actualizarCarrito" />
        </td>
        <td>
          <center>
